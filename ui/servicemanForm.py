...
"""
Module implementing serviceman.
"""

from PyQt5 import QtSql
from PyQt5.QtCore import pyqtSlot, pyqtSignal, QDate, QSortFilterProxyModel, Qt, QModelIndex, QPoint
from PyQt5.QtWidgets import QMainWindow,QHeaderView, QMenu
from PyQt5.QtGui import QIcon, QPixmap

from .Ui_servicemanForm import Ui_MainWindow
from .models import operatorModel as Model
import configparser

class serviceman(QMainWindow, Ui_MainWindow):
    """
    ...
    def __init__(self, user, parent=None):
        ...
        @type QWidget
        """
        super(serviceman, self).__init__(parent)
        self.setupUi(self)
...
#        self.tableView.customContextMenuRequested[QPoint].connect(self.contextMenuRequested)
    ...
    def contextMenuRequested(self, point):
        ...
        takeToWorkAction = contextMenu.addAction("Принять со склада")
